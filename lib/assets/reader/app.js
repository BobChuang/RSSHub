...
function getAiSummaryPromptForFeeds(feedIds) {
    return feedIds.map((feedId) => getFeed(feedId)?.aiSummaryPrompt).find(Boolean) || defaultAiSummaryPrompt;
}
...
function openAiSummaryForFeeds(feedIds, title) {
    ...
    initialAiSummaryPrompt = getAiSummaryPromptForFeeds(feedIds);
