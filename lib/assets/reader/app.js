...
async function submitAiSummary(event) {
    ...
    const feedIds = summarizingUsesChannelPicker ? getAiSummarySelectedFeedIds() : summarizingFeedIds.length ? summarizingFeedIds : summarizingFeedId ? [summarizingFeedId] : [];
    if (!feedIds.length) {
